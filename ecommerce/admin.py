...
class EcommIntegrationAdmin(admin.ModelAdmin):
    ...
    readonly_fields = ('retailer_name', 'retailer_id',)
    ...
    list_per_page = 50
    actions = [disconnect_bigcommerce, disconnect_woocommerce, disconnect_shopify, connect_bigcommerce, connect_woocommerce, connect_shopify]
